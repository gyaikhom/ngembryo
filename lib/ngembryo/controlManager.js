...
var ControlManager = new Class({
    ...
    initialize: function(controls){
        ...
        var tcm = dojo.create("div", {
            id: "minimiseControls"
        }, ctrl);
        this.connections.push(dojo.connect(tcm, "onclick", function(){
            ...
            if (ngembryo.engine.isControlsActive()) {
                ...
                tcvDrag.detach();
                dojo.style('toggleControls', 'cursor', 'default');
                dojo.style('minimiseControls', 'background', 'url(../../resources/images/green.png)');
                tcv.innerHTML = "Controls panel: click on green icon to show panel";
                ...
                tcvDrag.attach();
                dojo.style('toggleControls', 'cursor', 'pointer');
                dojo.style('minimiseControls', 'background', 'url(../../resources/images/tabClose.png)');
                tcv.innerHTML = "Controls panel: drag here to move the panel";
