...
/**
 * Reformats a text area by removing new-line characters and checking limit.
 * 
 * @param {Object} f Text area field.
 * @param {Integer} n Number of characters allowed.
 */
...
var DialogManager = new Class(
    {
        ...
        setCreateMarkerDialog: function(x, y, scale, lid) {
            dojo
                .xhrGet({
                url: "createMarkerForm.php?x=" + x + "&y=" + y + "&scale="
                    + scale + "&lid=" + lid,
                handleAs: "text",
                timeout: 5000, /* Time in milliseconds. */
                load: function(response, ioArgs) {
        ...
        setCreateRegionDialog: function(polyline, scale, lid) {
            ...
            dojo
                .xhrGet({
                url: "createRegionForm.php?polyline=" + str + "&scale="
                    + scale + "&lid=" + lid,
                handleAs: "text",
                timeout: 5000, /* Time in milliseconds. */
                load: function(response, ioArgs) {
         ...
         * @param {Real} scale Scaling factor.
         * @param {Integer} dst Distance within the model.
         * @param {Integer} yaw Model orientation yaw.
         * @param {Integer} rol Model orientation roll.
         * @param {Integer} pit Model orientation pitch.
         */
