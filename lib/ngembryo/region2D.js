...
var Region2D = new Class({
    ...
    draw: function(surface){
        if ($defined(surface)) {
            ...
            dojo.style(rp.getNode(), "cursor", "pointer");
            ...
            this.ec.push(dojo.connect(rp.getNode(), "onmouseenter", home));
            ...
            this.ec.push(dojo.connect(rp.getNode(), "onmousemove", homm));
            
            var homc = function(event){
                ngembryo.content.tipper.hide();
                ngembryo.dialogManager.showResources(id, l, d, t);
            }
            this.ec.push(dojo.connect(rp.getNode(), "onclick", homc));
            
            var homl = function(){
                ngembryo.content.tipper.hide();
                rp.setFill([100, 0, 0, 0.25]);
            };
            this.ec.push(dojo.connect(rp.getNode(), "onmouseleave", homl));
