    ...
    draw: function(surface, labelRenderer){
        if ($defined(surface)) {
            ...
            if (dojo.isObject(i)) {
                ...
                markerIcon.connect("onmouseenter", function(){
                ...
                markerIcon.connect("onmouseleave", function(){
                    clearTimeout(timer);
                });
                markerIcon.connect("onclick", function(){
                    ngembryo.dialogManager.showResources(grpMarker.id, grpMarker.label, grpMarker.description, grpMarker.type);
                });
                
                markerIconH.connect("onmouseleave", function(){
                    if (!ngembryo.engine.isMarker2DLabelVisible()) {
						clearTimeout(timer);
                ...
                markerIconH.connect("onclick", function(){
                    ngembryo.dialogManager.showResources(grpMarker.id, grpMarker.label, grpMarker.description, grpMarker.type);
                });
