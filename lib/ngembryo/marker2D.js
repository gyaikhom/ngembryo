    ...
    draw: function(surface){
        if ($defined(surface)) {
            ...
            if (dojo.isObject(i)) {
                ...
                dojo.style(mi.getNode(), "cursor", "pointer");
                ...
                this.ec.push(dojo.connect(mi.getNode(), "onmouseenter", home));
                
                var homl = function(){
                    ngembryo.content.tipper.hide();
                }
                this.ec.push(dojo.connect(mi.getNode(), "onmouseleave", homl));
                
                var homc = function(){
                    ngembryo.content.tipper.hide();
                    ngembryo.dialogManager.showResources(id, l, d, t);
                }
                this.ec.push(dojo.connect(mi.getNode(), "onclick", homc));
