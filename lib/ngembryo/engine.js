...
var AnnotationEngine = new Class({
    ...
    createRegion: function(grpRegion, px, py){
        ...
        if (this.__isCloseToFinalPoint(px, py)) {
            ...
            ngembryo.dialogManager.create2DRegion(this.regionPoints, woolz.model.scl.cur, woolz.model.dst.cur, woolz.model.yaw.cur, woolz.model.rol.cur, woolz.model.pit.cur);
    ...
    activateCreateCanvas2DMarker: function(){
        if ($defined(this.surface)) {
            ...
            this.eventCanvas2DMarker.push(dojo.connect(cc.getNode(), "onclick", function(event){
                ...
                ngembryo.dialogManager.create2DMarker(x, y, woolz.model.scl.cur, woolz.model.dst.cur, woolz.model.yaw.cur, woolz.model.rol.cur, woolz.model.pit.cur);
            }));
    ...
    activateCreateCanvas2DRegion: function(){
        if ($defined(this.surface)) {
            ...
            this.eventCanvas2DRegion.push(dojo.connect(cc.getNode(), "onclick", function(event){
                var x = event.clientX - ngembryo.engine.dim.x;
                var y = event.clientY - ngembryo.engine.dim.y;
                var temp = ngembryo.engine.createRegion(grpRegion, x, y);
            }));
            this.eventCanvas2DRegion.push(dojo.connect(cc.getNode(), "onmousemove", function(event){
                if (ngembryo.engine.regionPoints.length > 0) {
                    ...
                    ngembryo.engine.eventLastPoint.push(dojo.connect(circ.getNode(), "onclick", function(event){
                         ...
                         */
                        ngembryo.engine.createRegion(grpRegion, ngembryo.engine.regionPoints[0].x, ngembryo.engine.regionPoints[0].y);
