...
var AnnotationEngine = new Class({
    initialize: function(target){
        ...
        this.m2DLV = this.cookieManager.get("m2dlv", false); // If true, displays 2D marker labels.
        this.m3DV = this.cookieManager.get("m3dv", true); // If true, displays 3D markers.
        this.m3DLV = this.cookieManager.get("m3dlv", false); // If true, displays 3D marker labels.
        this.r2DV = this.cookieManager.get("r2dv", true); // If true, displays 2D regions.
        this.r2DLV = this.cookieManager.get("r2dlv", false); // If true, displays 2D region labels.
    ...
    showMarker2DLabel: function(){
        this.m2DLV = true;
        this.cookieManager.set("m2dlv", this.m2DLV);
    },
    ...
    showMarker3DLabel: function(){
        this.m3DLV = true;
        this.cookieManager.set("m3dlv", this.m3DLV);
    },
    ...
    showRegion2DLabel: function(){
        this.r2DLV = true;
        this.cookieManager.set("r2dlv", this.r2DLV);
    },
