...
var Resource = new Class(
		{
			...
			create : function(flag) {
				...
				crd = new dijit.Dialog( {
					...
					style : "width: 590px;",
					content : this.__getForm("crF.php"),
					onHide : function() {
						if (flag) {
			...
			deleteItem : function(rid, iid) {
				return this.__get("dri.php?rid=" + rid + "&iid="
						+ iid);
			},
