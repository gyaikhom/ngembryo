        ...
        var rbd = new dijit.Dialog({
            ...
            onFocus: function(){
                ...
                if ($defined(ngembryo.resource.items) && ngembryo.resource.items.length > 0) {
                    ...
                    var list = "<table id='items'><tr><th>Author</th><th>Title</th><th>Abstract</th></tr>";
            ...
            onFocus: function(){
                ...
                if ($defined(ngembryo.resource.items) && ngembryo.resource.items.length > 0) {
                    ...
                    if (index != -1) {
                        ...
                        if ($defined(ritems)) {
                            list += "<table id='items'><tr><th>Title</th><th>Abstract</th><th>mime</th><th>Link</th></tr>";
