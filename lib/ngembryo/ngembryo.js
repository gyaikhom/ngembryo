...
var NGEmbryo = new Class({
     ...
     */
    initialize: function(){
        // This is for controllong event handling.
        // setByUser is set to true if the event was raised by user intervention.
        // otherwise, it is set to false. This resolves recursive event handling
        // where event trigger each other circularly.
        this.setByUser = true;
