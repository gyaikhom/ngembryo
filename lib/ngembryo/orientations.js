/**
 * Encapsulates model orientation.
 * 
...
var Orientation = new Class({
    ...
    create: function(flag) {
        ...
        var url = "createOrientationForm.php?model=" + model +
            "&distance=" + distance + "&yaw="
    ...
    deleteOrientation: function(e, oid, i) {
        confirmDialog("Delete orientation",
            ...
            if (flag) {
                ...
                ngembryo.orientation.__get("deleteOrientation.php?oid=" + oid);
                if (oid === ngembryo.oid)
                    ngembryo.oid = -1;
