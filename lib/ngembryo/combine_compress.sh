...
for x in utils models annotation icon iconManager layerManager marker region engine cookieManager overlays woolz dialogManager orientations layers resources toolbar controlManager tipper feedback content ngembryo;
  do
