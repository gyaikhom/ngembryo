...
var Content = new Class({
    initialize: function(a){
        ...
        /* Create shodow for target frame. */
        ...
        /* When the cursor hovers over annotations, information
         * is displayed relative to the position of the mouse cursor.
         * Create the <div> which contains this information.
         */
